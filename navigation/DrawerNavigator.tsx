...
export default function DrawerNavigator() {
  return (
    ...
    >
      <Drawer.Screen name="Home" component={HomeScreen} options={{ title: 'Home', drawerIcon: ({color, size}: {color: string; size: number}) => (<Icon name="home-outline" color={color} size={size} />) }} />
      
      <Drawer.Screen name="TeacherDashboard" component={TeacherDashboardScreen} options={{ title: 'Teacher Dashboard', drawerIcon: ({color, size}: {color: string; size: number}) => (<Icon name="view-dashboard-outline" color={color} size={size} />) }} />
